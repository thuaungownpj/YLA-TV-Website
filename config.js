    ...
    return {
        ...
        content: {
            android: {
                ...
                links: [
                    { name: "Download Link 1", url: "https://cdn.ylatv.com/file/download-apk/android/YLA-TV(v2.6).apk", icon: "fab fa-android" },
                    { name: "Download Link 2", url: "https://cdn.balthumamathonebuu.store/file/download-apk/android/YLA-TV(v2.6).apk", icon: "fas fa-download" },
                    { name: "Download Link 3", url: "https://cdn.ylatvapp.store/file/download-apk/android/YLA-TV(v2.6).apk", icon: "fas fa-cloud-download-alt" }
                ],
            ...
            windows: {
                ...
                links: [
                    { name: "Download Link 1", url: "https://cdn.balthumamathonebuu.store/file/download-apk/windows/YLATV_Setup.exe", icon: "fab fa-windows", note: "Version 1.1" },
